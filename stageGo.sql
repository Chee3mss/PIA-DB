...
--
-- Servidor: 72.60.123.201:5984
-- Tiempo de generación: 14-11-2025 a las 00:11:54
...
--
-- Base de datos: `stageGo`
--
create	database stageGo;
use stageGo;
-- --------------------------------------------------------
...
INSERT INTO `Auditorio` (`id_auditorio`, `nombre`, `capacidad`, `id_sede`) VALUES
(1, 'Auditorio Principal', 12000, 1),
(2, 'Sala Central', 2000, 2);
...
INSERT INTO `Boletos` (`id_boleto`, `asiento`, `precio_final`, `vigente`, `id_tipo_boleto`, `id_estado_boleto`, `id_funcion`, `id_venta`) VALUES
(1, 'A1', 1200.00, b'1', 1, 3, 1, 1),
(2, 'A2', 1200.00, b'1', 1, 3, 1, 1),
(3, 'A3', 1500.00, b'1', 1, 1, 1, NULL),
(4, 'A4', 1500.00, b'1', 1, 1, 1, NULL),
(5, 'B10', 500.00, b'1', 2, 3, 2, 2),
(6, 'B11', 500.00, b'1', 2, 1, 2, NULL),
(7, 'B12', 500.00, b'1', 2, 1, 2, NULL);
...
INSERT INTO `Clientes` (`id_cliente`, `nombre_completo`, `email`, `password_hash`, `telefono`, `numero_registro`, `fecha_registro`, `id_municipio`) VALUES
(1, 'Carlos Perez', 'carlos.perez@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '8188899900', 'C001', '2025-11-01', 19039),
(2, 'Maria Lopez', 'maria.lopez@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '8187788990', 'C002', '2025-11-02', 14039);
...
INSERT INTO `Empleado` (`id_empleado`, `nombre`, `apellido`, `email`, `password_hash`, `telefono`, `salario`, `id_estado_empleado`, `id_tipo_empleado`) VALUES
(1, 'Admin', 'Sistema', 'admin@stagego.com', '$2a$10$rOOqKCqW8x.9pzB.WQe0me7cO5n3YZGk5Xhh5Z7gXZdH4YkMQFjW6', '8199999999', 20000.00, 1, 3),
(2, 'Luis', 'Salinas', 'luis.salinas@stagego.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '8123456789', 9500.00, 1, 1),
(3, 'Ana', 'Garcia', 'ana.garcia@stagego.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '8111122233', 16000.00, 1, 2);
...
--
-- Estructura de tabla para la tabla `Estado_Boleto`
--
...
--
-- Volcado de datos para la tabla `Estado_Boleto`
--

INSERT INTO `Estado_Boleto` (`id_estado_boleto`, `nombre`, `descripcion`) VALUES
(1, 'Disponible', 'Boleto disponible para la venta'),
(2, 'Reservado', 'Boleto temporalmente reservado'),
(3, 'Vendido', 'Boleto vendido y pagado'),
(4, 'Cancelado', 'Boleto cancelado');
...
INSERT INTO `Estado_Empleado` (`id_estado_empleado`, `nombre`, `descripcion`) VALUES
(1, 'Activo', 'Empleado en funciones'),
(2, 'Inactivo', 'Empleado dado de baja');
...
INSERT INTO `Evento` (`id_evento`, `nombre_evento`, `descripcion`, `imagen_url`, `clasificacion`, `fecha_inicio`, `fecha_fin`, `id_tipo_evento`, `id_empleado`) VALUES
(1, 'Concierto de Coldplay', 'Presentación de la banda británica con su tour mundial 2025. Una experiencia musical inolvidable.', 'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=800', 'Todo Público', '2025-12-01 20:00:00', '2025-12-01 23:00:00', 1, 1),
(2, 'Bad Bunny World Tourrr', 'El conejo malo regresa a México con su tour más esperado del año.', 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800', 'Todo Público', '2025-11-15 21:00:00', '2025-11-15 23:30:00', 1, 1),
(3, 'Festival Pa\'l Norte 2025', 'El festival más grande del norte de México con artistas internacionales.', 'https://www.google.com/url?sa=i&url=https%3A%2F%2Faiplay.mx%2Ftecate-pal-norte%2F&psig=AOvVaw2yf0AuxtEe3I-Qm1Q_EWbL&ust=1763058578284000&source=images&cd=vfe&opi=89978449&ved=0CBYQjRxqFwoTCPDliJSf7ZADFQAAAAAdAAAAABAE', 'Mayor 18', '2025-03-20 14:00:00', '2025-03-22 02:00:00', 5, 1),
(4, 'Karol G - Mañana Será Bonito Tour', 'La bichota llega con su mejor show. Una noche llena de reggaetón y emociones.', 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800', 'Mayor 12', '2025-11-28 21:00:00', '2025-11-28 23:30:00', 1, 1),
(5, 'Metallica En Concierto', 'Los reyes del metal regresan con un show épico lleno de clásicos.', 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=800', 'Mayor 18', '2025-12-18 20:00:00', '2025-12-18 23:00:00', 1, 1),
(6, 'Grupo Firme - Tour 2025', 'La banda mexicana más popular presenta su nuevo tour.', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800', 'Todo Público', '2025-12-22 21:00:00', '2025-12-22 23:30:00', 1, 1),
(7, 'El Rey León', 'Obra de teatro musical basada en la película de Disney. Una experiencia mágica.', 'https://images.unsplash.com/photo-1503095396549-807759245b35?w=800', 'Todo Público', '2025-11-20 19:00:00', '2025-11-30 21:30:00', 2, 1),
(8, 'Romeo y Julieta plus', 'La clásica obra de Shakespeare en una adaptación moderna y emocionante.', 'https://anagnorisis.es/wp-content/uploads/2024/06/romeo-y-julieta-obra-de-teatro-2-800x521.jpg', 'Mayor 12', '2025-12-10 20:00:00', '2025-12-20 22:00:00', 2, 1),
(9, 'Hamilton México', 'El musical más aclamado de Broadway llega a México por primera vez.', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800', 'Mayor 12', '2025-11-30 20:00:00', '2025-12-15 22:00:00', 2, 1),
(10, 'La Casa de Bernarda Alba', 'Una de las obras más emblemáticas del teatro español. Imperdible.', 'https://images.unsplash.com/photo-1507924538820-ede94a04019d?w=800', 'Mayor 15', '2026-01-05 19:00:00', '2026-01-20 21:00:00', 2, 1),
(11, 'Final Liga MX', 'Gran final del torneo de fútbol mexicano. ¡No te lo pierdas!', 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800', 'Todo Público', '2025-12-15 19:00:00', '2025-12-15 21:00:00', 3, 1),
(12, 'NBA Mexico Game', 'Juego de la NBA en territorio mexicano. Espectáculo deportivo de clase mundial.', 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800', 'Todo Público', '2025-12-05 20:00:00', '2025-12-05 22:30:00', 3, 1),
(13, 'WWE Monday Night Raw', 'La WWE llega a México con sus mejores superestrellas en vivo.', 'https://images.unsplash.com/photo-1587329310686-91414b8e3cb7?w=800', 'Todo Público', '2025-11-30 20:00:00', '2025-11-30 23:00:00', 3, 1),
(14, 'Pelea Canelo Álvarez', 'El mejor boxeador mexicano defiende su título mundial.', 'https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?w=800', 'Mayor 18', '2025-12-20 20:00:00', '2025-12-20 23:00:00', 3, 1),
(15, 'Franco Escamilla', 'El comediante más famoso de México presenta su nuevo show.', 'https://images.unsplash.com/photo-1585699324551-f6c309eedeca?w=800', 'Mayor 18', '2025-11-25 21:00:00', '2025-11-25 23:00:00', 4, 1),
(16, 'Eugenio Derbez Live', 'El actor y comediante presenta un show único lleno de risas.', 'https://images.unsplash.com/photo-1527224857830-43a7acc85260?w=800', 'Mayor 12', '2025-12-08 20:00:00', '2025-12-08 22:00:00', 4, 1),
(17, 'Chumel Torres - El Pulso', 'Análisis político con humor. El conductor más polémico de México.', 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=800', 'Mayor 18', '2025-12-02 21:00:00', '2025-12-02 23:00:00', 4, 1),
(18, 'Adal Ramones - Otro Rollo Live', 'El legendario conductor regresa con su show de comedia.', 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fes.wikipedia.org%2Fwiki%2FAdal_Ramones&psig=AOvVaw3MbRnTxyVU5wrGS5ylSzJQ&ust=1763058475149000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCODPsuSe7ZADFQAAAAAdAAAAABAE', 'Mayor 12', '2025-12-16 20:00:00', '2025-12-16 22:00:00', 4, 1),
(19, 'Tech Summit 2025', 'La conferencia de tecnología más importante de Latinoamérica.', 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800', 'Todo Público', '2025-11-18 09:00:00', '2025-11-19 18:00:00', 6, 1),
(20, 'Marketing Digital Expo', 'Aprende de los mejores expertos en marketing digital y redes sociales.', 'https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=800', 'Mayor 18', '2025-12-12 10:00:00', '2025-12-12 19:00:00', 6, 1),
(21, 'Cumbre de Innovación', 'Los líderes empresariales más influyentes comparten sus experiencias.', 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=800', 'Todo Público', '2025-12-08 08:00:00', '2025-12-08 19:00:00', 6, 1);
...
INSERT INTO `Funciones` (`id_funcion`, `fecha`, `hora`, `estado`, `boletos_vendidos`, `recaudacion`, `id_evento`, `id_auditorio`) VALUES
(1, '2025-12-01', '20:00:00', 'Programada', 0, 0.00, 1, 1),
(2, '2025-11-25', '19:00:00', 'Programada', 0, 0.00, 2, 2);
...
INSERT INTO `Metodo_Pago` (`id_metodo`, `nombre_metodo`, `descripcion`, `comision`, `activo`) VALUES
(1, 'Tarjeta de crédito', 'Pago con tarjeta VISA/MasterCard', 2.50, b'1'),
(2, 'Efectivo', 'Pago en taquilla', 0.00, b'1');
...
INSERT INTO `Promociones` (`id_promocion`, `nombre_promocion`, `descripcion`, `descuento`, `fecha_inicio`, `fecha_fin`, `activo`, `usos_maximos`, `usos_actuales`) VALUES
(1, 'Black Friday', 'Descuento especial del 20%', 20.00, '2025-11-25', '2025-11-30', b'1', 100, 0),
(2, 'Navidad', 'Descuento navideño del 15%', 15.00, '2025-12-10', '2025-12-25', b'1', 50, 0);
...
INSERT INTO `Sede` (`id_sede`, `nombre_sede`, `direccion`, `ciudad`, `telefono`, `capacidad_total`, `activo`) VALUES
(1, 'Arena Monterrey', 'Av. Fundidora 501', 'Monterrey', '8122233344', 15000, b'1'),
(2, 'Teatro Diana', 'Av. 16 de Septiembre 710', 'Guadalajara', '3334455566', 2500, b'1');
...
INSERT INTO `Tipo_Boleto` (`id_tipo_boleto`, `nombre_tipo`, `descripcion`, `precio_base`, `activo`, `id_zona`) VALUES
(1, 'VIP Premium', 'Asiento en zona VIP', 1500.00, b'1', 1),
(2, 'General', 'Asiento en zona general', 500.00, b'1', 2);
...
INSERT INTO `Tipo_Empleado` (`id_tipo_empleado`, `nombre_tipo`, `descripcion`, `salario_base`) VALUES
(1, 'Taquillero', 'Encargado de venta de boletos', 8500.00),
(2, 'Administrador', 'Gestiona eventos y personal', 15000.00),
(3, 'Superusuario', 'Control total del sistema', 20000.00);
...
INSERT INTO `Tipo_Evento` (`id_tipo_evento`, `nombre_tipo`, `descripcion`, `activo`) VALUES
(1, 'Concierto', 'Eventos musicales en vivo', b'1'),
(2, 'Obra de Teatro', 'Representaciones teatrales', b'1'),
(3, 'Deportes', 'Eventos deportivos', b'1'),
(4, 'Stand-Up Comedy', 'Shows de comedia', b'1'),
(5, 'Festival', 'Festivales y eventos masivos', b'1'),
(6, 'Conferencia', 'Charlas y conferencias', b'1');
...
INSERT INTO `Ventas` (`id_venta`, `fecha`, `total`, `impuestos`, `id_cliente`, `id_empleado`, `id_metodo`, `id_promocion`) VALUES
(1, '2025-11-05', 2400.00, 384.00, 1, 1, 1, 1),
(2, '2025-11-06', 500.00, 80.00, 2, 1, 2, NULL);
...
INSERT INTO `Zonas` (`id_zona`, `nombre_zona`, `capacidad`, `descripcion`, `precio_multiplicador`, `id_auditorio`) VALUES
(1, 'VIP', 500, 'Zona preferente', 2.00, 1),
(2, 'General', 11500, 'Zona general', 1.00, 1);
...
ALTER TABLE `Boletos`
  ...
  ADD KEY `id_tipo_boleto` (`id_tipo_boleto`),
  ADD KEY `id_estado_boleto` (`id_estado_boleto`),
...
--
-- Indices de la tabla `Estado_Boleto`
--
ALTER TABLE `Estado_Boleto`
  ADD PRIMARY KEY (`id_estado_boleto`);
...
ALTER TABLE `Funciones`
  ...
  ADD KEY `id_auditorio` (`id_auditorio`);
...
--
-- Indices de la tabla `Tipo_Boleto`
--
ALTER TABLE `Tipo_Boleto`
  ADD PRIMARY KEY (`id_tipo_boleto`),
...
--
ALTER TABLE `Auditorio`
  MODIFY `id_auditorio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `Boletos`
--
ALTER TABLE `Boletos`
  MODIFY `id_boleto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT de la tabla `Estado_Boleto`
--
ALTER TABLE `Estado_Boleto`
  MODIFY `id_estado_boleto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `Estado_Empleado`
--
ALTER TABLE `Estado_Empleado`
  MODIFY `id_estado_empleado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `Evento`
--
ALTER TABLE `Evento`
  MODIFY `id_evento` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `Funciones`
--
ALTER TABLE `Funciones`
  MODIFY `id_funcion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `Tipo_Boleto`
--
ALTER TABLE `Tipo_Boleto`
  MODIFY `id_tipo_boleto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `Tipo_Empleado`
--
ALTER TABLE `Tipo_Empleado`
  MODIFY `id_tipo_empleado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `Auditorio`
  ADD CONSTRAINT `Auditorio_ibfk_1` FOREIGN KEY (`id_sede`) REFERENCES `Sede` (`id_sede`);

--
-- Filtros para la tabla `Boletos`
--
ALTER TABLE `Boletos`
  ADD CONSTRAINT `Boletos_ibfk_1` FOREIGN KEY (`id_tipo_boleto`) REFERENCES `Tipo_Boleto` (`id_tipo_boleto`),
  ADD CONSTRAINT `Boletos_ibfk_2` FOREIGN KEY (`id_estado_boleto`) REFERENCES `Estado_Boleto` (`id_estado_boleto`),
  ADD CONSTRAINT `Boletos_ibfk_3` FOREIGN KEY (`id_funcion`) REFERENCES `Funciones` (`id_funcion`),
  ADD CONSTRAINT `Boletos_ibfk_4` FOREIGN KEY (`id_venta`) REFERENCES `Ventas` (`id_venta`);
...
--
ALTER TABLE `Empleado`
  ADD CONSTRAINT `Empleado_ibfk_1` FOREIGN KEY (`id_estado_empleado`) REFERENCES `Estado_Empleado` (`id_estado_empleado`),
...
--
ALTER TABLE `Evento`
  ADD CONSTRAINT `Evento_ibfk_1` FOREIGN KEY (`id_tipo_evento`) REFERENCES `Tipo_Evento` (`id_tipo_evento`),
  ADD CONSTRAINT `Evento_ibfk_2` FOREIGN KEY (`id_empleado`) REFERENCES `Empleado` (`id_empleado`);

--
-- Filtros para la tabla `Funciones`
--
ALTER TABLE `Funciones`
  ADD CONSTRAINT `Funciones_ibfk_1` FOREIGN KEY (`id_evento`) REFERENCES `Evento` (`id_evento`),
  ADD CONSTRAINT `Funciones_ibfk_2` FOREIGN KEY (`id_auditorio`) REFERENCES `Auditorio` (`id_auditorio`);
...
--
-- Filtros para la tabla `Tipo_Boleto`
--
ALTER TABLE `Tipo_Boleto`
  ADD CONSTRAINT `Tipo_Boleto_ibfk_1` FOREIGN KEY (`id_zona`) REFERENCES `Zonas` (`id_zona`);
...
ALTER TABLE `Ventas`
  ...
  ADD CONSTRAINT `Ventas_ibfk_3` FOREIGN KEY (`id_metodo`) REFERENCES `Metodo_Pago` (`id_metodo`),
  ADD CONSTRAINT `Ventas_ibfk_4` FOREIGN KEY (`id_promocion`) REFERENCES `Promociones` (`id_promocion`);

--
-- Filtros para la tabla `Zonas`
--
ALTER TABLE `Zonas`
  ADD CONSTRAINT `Zonas_ibfk_1` FOREIGN KEY (`id_auditorio`) REFERENCES `Auditorio` (`id_auditorio`);
COMMIT;
