...
-- ============================================
-- INSTRUCCIONES:
-- 1. Primero ejecuta PIA-BDD.sql para crear el schema
-- 2. Luego ejecuta este archivo para cargar estados y municipios
-- ============================================
...
-- ============================================
-- MUNICIPIOS DE MÉXICO (2,469 municipios completos)
-- ============================================
...
INSERT INTO Clientes (nombre_completo, email, password_hash, telefono, numero_registro, fecha_registro, id_municipio)
VALUES ('Carlos Perez', 'carlos.perez@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '8188899900', 'C001', '2025-11-01', 19039),
       ('Maria Lopez', 'maria.lopez@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '8187788990', 'C002', '2025-11-02', 14039);


INSERT INTO Ventas (fecha, total, impuestos, id_cliente, id_empleado, id_metodo, id_promocion)
VALUES ('2025-11-05', 2400.00, 384.00, 
        (SELECT id_cliente FROM Clientes WHERE numero_registro = 'C001'), 
        1, 1, 1),
       ('2025-11-06', 500.00, 80.00, 
        (SELECT id_cliente FROM Clientes WHERE numero_registro = 'C002'), 
        1, 2, NULL);


INSERT INTO Boletos (asiento, precio_final, vigente, id_tipo_boleto, id_estado_boleto, id_funcion, id_venta)
VALUES ('A1', 1200.00, 1, 1, 3, 1, (SELECT MIN(id_venta) FROM Ventas WHERE fecha = '2025-11-05')),
       ('A2', 1200.00, 1, 1, 3, 1, (SELECT MIN(id_venta) FROM Ventas WHERE fecha = '2025-11-05')),
       ('A3', 1500.00, 1, 1, 1, 1, NULL),
       ('A4', 1500.00, 1, 1, 1, 1, NULL),
       ('B10', 500.00, 1, 2, 3, 2, (SELECT MIN(id_venta) FROM Ventas WHERE fecha = '2025-11-06')),
       ('B11', 500.00, 1, 2, 1, 2, NULL),
       ('B12', 500.00, 1, 2, 1, 2, NULL);
